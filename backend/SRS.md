...
- Room attributes: name, property type, capacity, description, status (available, occupied, maintenance)

### 3.4 Booking Management
- Create, view, edit, cancel bookings
- Booking attributes: room, contact name, contact email, contact phone, institution, start date, end date, status (scheduled, in_use, finished, cancelled)
