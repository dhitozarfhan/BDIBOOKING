<aside class="w-64 min-h-screen bg-base-100 border-r border-base-200 flex flex-col shrink-0">
    ...
    <div class="px-3 py-4 border-t border-base-200">
        <button wire:click="logout" class="flex items-center gap-3 w-full px-3 py-2.5 rounded-lg text-sm font-medium text-red-500/70 hover:bg-red-50 hover:text-red-600 transition-all duration-150">
