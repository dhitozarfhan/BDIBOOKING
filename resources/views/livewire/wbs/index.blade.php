        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 lg:gap-4">
            <div class="lg:col-span-8 mb-6 lg:mb-0">
                ...
                <div class="mt-4 prose max-w-none">
                    <p>{{ __('WBS (Whistle Blowing System) adalah sistem pelaporan pelanggaran yang dapat digunakan oleh pegawai atau masyarakat untuk melaporkan dugaan pelanggaran yang terjadi di lingkungan BDI Yogyakarta.') }}</p>
                    <p>{{ __('Laporan yang Anda sampaikan akan dirahasiakan dan ditindaklanjuti sesuai dengan ketentuan yang berlaku.') }}</p>
                    <h6>{{ __('Jenis-jenis pelanggaran yang dapat dilaporkan') }}</h6>
                    <ul>
                        <li>{{ __('Korupsi') }}</li>
                        <li>{{ __('Suap') }}</li>
                        <li>{{ __('Pemerasan') }}</li>
                        <li>{{ __('Penyalahgunaan wewenang') }}</li>
                        <li>{{ __('Pencurian') }}</li>
                        <li>{{ __('Kolusi') }}</li>
                        <li>{{ __('Kekerasan') }}</li>
                        <li>{{ __('Diskriminasi') }}</li>
                    </ul>
                    <h6>{{ __('Saluran Pelaporan') }}</h6>
                        ...
                        <table class="table w-full">
                            <tbody>
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <a href="{{ route('wbs.form') }}" class="link link-primary">{{ __('WBS Report Form') }}</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>{{ __('Letter') }}</td>
