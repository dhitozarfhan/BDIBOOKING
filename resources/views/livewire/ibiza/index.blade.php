        ...
        <div class="card bg-base-100 shadow-xl border border-base-200 mb-10">
            <div class="card-body prose max-w-none">
                ...
                <p class="text-base-content/80">
                    ...
                    <b>Undang-undang No. 3 Tahun 2014</b>
                    tentang Perindustrian menyebutkan bahwa pembinaan sumber daya manusia industri juga mencakup
                    pembinaan wirausaha
                    industri yang mana tujuannya adalah untuk menciptakan wirausaha yang berkarakter dan bermental
                    kewirausahaan serta
                    berkompetensi di bidang usahanya. Pembinaan wirausaha industri dilakukan melalui pelatihan,
                    kemitraan dan inkubator
                    wirausaha atau inkubator industri.
                    <br>
                    Pada tahap perkembangan bisnis, yang paling banyak menghadapi risiko kegagalan yaitu bisnis pada
                    tahap pemula
                    (<em>start up</em>). Oleh karena itu, di negara-negara maju seperti Amerika dan negara-negara
                    Eropa, mereka membentuk system
                    atau infrastruktur agar resiko dapat diperkecil, dengan membuat lembaga yang namanya
                    <b><em>incubator</em></b>, yaitu suatu fasilitas
                    dan aktivitas yang diberikan kepada pengusaha pemula yang biasa disebut penyewa (tenant) dalam
                    bentuk fisik, misalnya
                    tempat memulai mengembangkan usaha, fasilitas produksi, pelayanan pelatihan, akses kepada
                    teknologi, tenaga kerja, modal
                    dan pasar. Di sini pengusaha saling berinteraksi sehingga dapat saling tolong menolong, berbagi
                    pengalaman, dan sebagainya,
                    yang menyebabkan inkubator menjadi tempat kondusif untuk tumbuhnya usaha baru.
                </p>
            </div>
        </div>
