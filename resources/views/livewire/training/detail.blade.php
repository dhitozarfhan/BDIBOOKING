<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-8">
    ...
    <div>
                ...
                <div class="card bg-base-100 shadow-md mt-6 lg:mt-0 w-full lg:w-96 shrink-0">
                    ...
                    <div class="card-body px-5 py-4">
                        <div class="flex flex-col gap-1 mb-4">
                                <span class="text-lg font-bold text-primary">{{ 'Rp ' . number_format($training->price, 0, ',', '.') }}</span>
                        ...
                        @if(Auth::guard('participant')->check())
                            ...
                            @else
                                <button wire:click="register" wire:confirm="Apakah Anda yakin ingin mendaftar diklat ini?" class="btn btn-primary btn-block">
                                    Daftar Sekarang
                                </button>
                            @endif
                        @else
                            ...
                            <p class="text-xs text-center mt-2 text-gray-500">
                                Belum punya akun? <a href="{{ route('participant.register') }}" class="underline hover:text-primary">Daftar disini</a>
                            </p>
                        @endif
                    </div>
                </div>
        ...
        <div class="card bg-base-100 shadow-xl mt-8 border border-base-200">
            <div class="card-body space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <!-- Price -->
                    <div class="p-4 rounded-xl bg-base-200/60 border border-base-200 flex flex-col gap-2">
                            <span class="text-xs font-semibold uppercase text-base-content/60">Biaya PNBP</span>
                            <div class="flex items-start gap-2 text-sm font-medium">
                            <svg class="w-5 h-5 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="mt-8 text-center">
            <a href="{{ route('training.index') }}" wire:navigate class="btn btn-ghost hover:bg-base-200">
