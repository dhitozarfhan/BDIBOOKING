    ...
    <div class="article-body grid grid-cols-12 gap-3 mt-5 items-start">
        ...
        <div class="col-span-8">
            <div class="article-meta flex py-1 text-sm items-center">
                ...
                <span class="text-gray-500 text-xs">. {{ $post->published_at->translatedFormat('d F Y') }}</span>
            </div>
            <h2 class="text-2xl font-bold text-gray-900 hover:text-blue-500">
                <a href="http://127.0.0.1:8000/blog/first%20post">
                    {{ $post->title }}
                </a>
            </h2>

            <p class="mt-2 text-base text-gray-700 text-justify font-light">
