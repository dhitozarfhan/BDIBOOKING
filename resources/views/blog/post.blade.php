        ...
        <div class="container mx-auto md:px-20">
            <div class="w-full grid grid-cols-4 gap-10">
                <div class="md:col-span-3 col-span-4">
                    <h1 class="text-4xl font-bold mb-10">{{ $blog->id_title }}</h1>
                    <div class="border-t border-b py-6 mb-10">
                        <div class="flex flex-col md:flex-row md:items-center">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <span class="block text-blue-600">
                                            <a href="">{{ \Carbon\Carbon::parse($blog->time_stamp)->translatedFormat('d F Y') }}</a>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="md:w-5/12">
                                <span class="text-lg font-semibold">
                                    <a href="">
                                        <i class="far fa-folder-open"></i> {{ $blog->category->id_name }}
                                    </a>
                                </span>
                                <span class="block text-blue-600">
                                    <a href="">
                    ...
                    <img class="mx-auto mb-12" width="720" src="{{ $blog->getThumbnailImage() }}" alt="{{ $blog->id_title }}">
                    <p class="text-gray-300">{!! $blog->id_content !!}</p>
                </div>
